...
import { Play, Square, Download, Share2, Settings, Code, Terminal, FileText, Loader } from 'lucide-react';
...
class Program
{
  ...
  const runCode = async () => {
    ...
    try {
      ...
      setOutput('Error: Failed to connect to execution service. Please check your internet connection and try again.');
    } finally {
      setIsRunning(false);
    }
  };
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="space-y-4">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Write, run, and experiment with code in {languages.length}+ programming languages. Perfect for learning, testing, and prototyping.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Choose from {languages.length} programming languages with full input/output support
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                description: 'Run your code instantly with our fast and reliable execution engine powered by Piston API.'
              },
              {
                icon: Terminal,
                title: 'Input/Output',
                description: 'Test your programs with custom input and see real-time output with error handling.'
              },
              {
                icon: Settings,
                title: 'Customizable',
                description: 'Choose your preferred theme, editor settings, and keyboard shortcuts for optimal coding experience.'
              }
            ].map((feature, index) => {
