...
export default function ResumeUpload({
  ...
  const handleUpload = async (file) => {
    // Allowed MIME types for PDF, DOCX, and DOC
    const allowedTypes = [
      "application/pdf",
    ...
    if (!file || !allowedTypes.includes(file.type)) {
      toast.error("Only PDF, DOCX, or DOC files are allowed");
      return;
    }

    // Delete previously uploaded file before uploading a new one
